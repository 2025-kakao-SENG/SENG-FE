    ...
    return (
        <div
            ...
            <div className="mt-[0.5625rem] flex flex-col flex-wrap gap-[0.5625rem]">
                <div className="flex flex-col rounded-[0.1875rem] bg-[#292929] p-[0.9375rem]">
                    ...
                    <p className="self-end text-[0.625rem] text-[#999999]">
                        2025-01-08
                    </p>
                </div>
                <div className="flex flex-col rounded-[0.1875rem] bg-[#292929] p-[0.9375rem]">
                    <p className="text-xs font-bold text-[#DBAC4A]">
                        500 토큰이 충전되었습니다.
                    </p>
                    <div className="my-1">
                        <p className="text-xs text-[#DBAC4A]">
                            안녕하세요 스토리브리즈입니다. Noah님의 토큰 충전
                            내역을 안내드립니다.
                        </p>
                        <p className="text-xs text-[#DBAC4A]">
            ...
            <h2 className="mt-[2.1875rem] flex flex-col flex-wrap text-sm font-semibold text-[#F5F5F5]">
                커뮤니티 알림
            </h2>

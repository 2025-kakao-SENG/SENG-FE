...
const bookMockData: BookData = {
    ...
    chapters: [
        ...
        {
            chapterIndex: 2,
            chapterTitle: 'Chapter 2: Gathering Courage',
            subChapters: [
                {
                    subChapterIndex: 1,
        ...
        {
            chapterIndex: 3,
            chapterTitle: 'Chapter 3: Into the Unknown',
            subChapters: [
                {
                    subChapterIndex: 1,
        ...
        {
            chapterIndex: 4,
            chapterTitle: 'Chapter 4: The Hidden Cave',
            subChapters: [
                {
                    subChapterIndex: 1,
        ...
        {
            chapterIndex: 5,
            chapterTitle: 'Chapter 5: Guardians of the Secret',
            subChapters: [
                {
                    subChapterIndex: 1,
        ...
        {
            chapterIndex: 6,
            chapterTitle: 'Chapter 6: Trials of the Cave',
            subChapters: [
                {
                    subChapterIndex: 1,
        ...
        {
            chapterIndex: 7,
            chapterTitle: 'Chapter 7: The Heart of the Cave',
            subChapters: [
                {
                    subChapterIndex: 1,
        ...
        {
            chapterIndex: 8,
            chapterTitle: 'Chapter 8: The Choice',
            subChapters: [
                {
                    subChapterIndex: 1,
        ...
        {
            chapterIndex: 9,
            chapterTitle: 'Chapter 9: The Return Journey',
            subChapters: [
                {
                    subChapterIndex: 1,
        ...
        {
            chapterIndex: 10,
            chapterTitle: 'Chapter 10: The Legacy',
            subChapters: [
                {
                    subChapterIndex: 1,
